...
# chatGPT - api_key
openai.api_key = "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"
...
def recommend_praise_scenario():
    ...
    if touched > 1:
        ...
        text_to_speech("Thank you for petting me! I'll recommend praise.")
...
def bible_recommend():
    ...
    if touched > 1:
        device_obj.send_cmd(20, '0,0,255')
        text_to_speech("Thank you for petting me! I'll recommend a Bible verse.")
...
def games():
    text_to_speech("Okay, Let's do a psychological test")
...
def test1():    
    ...
    text_to_speech("First, because you are on a diet")
    text_to_speech("Second. because you have diabetes")
    text_to_speech("Third. because the cake is not yours.")
...
def test2():
    ...
    text_to_speech("First. a broken toy")
    text_to_speech("Second. a picture")
    text_to_speech("Third. a candle")
    text_to_speech("Fourth. an id card")
...
def Start():
    ...
    if parse == 'negative':
        text_to_speech('Oh, I see. Let\'s do an activity with me!')
        text_to_speech('그랬구나. 나랑 활동 하나 하자!')
    ...
    # 부정이 아닐 경우, 직접 선택
        ...
        text_to_speech('Oh, I see!! Let\'s do an activity with me!')
        text_to_speech('그랬구나!!. 우리 같이 활동하자!')
